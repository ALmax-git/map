            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <li class="nav-item lh-1 me-3">
                        <a class="github-button" href="{{ route('dashboard') }}"
                                ...
                                <a class="dropdown-item" href="#">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">{{ Auth::user()->email ?? "alimustaphashettima@gmail.com" }}</small>
                                        </div>
                                    </div>
                                </a>
                            </li>
        ...
        <div class="container">
            ...
            <footer class="content-footer footer bg-footer-theme">
                <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                    ...
                    <div>
                        <a href="https://github.com/ALmax-git" class="footer-link me-4"
                            target="_blank">License</a>
                        <a href="https://github.com/ALmax-git" target="_blank" class="footer-link me-4">More Themes</a>

                        <a href="https://github.com/ALmax-git"
                            target="_blank" class="footer-link me-4">Documentation</a>

                        <a href="mailto:alimustaphashettima@gmail.com"
